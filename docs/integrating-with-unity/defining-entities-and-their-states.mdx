---
sidebar_label: 'Defining Entities and their States'
---
...
`isPlayer` | `boolean` | If true, this state belongs to a player controlled object; whether by a bot or a human player. That player may or may not be driven by a bot.
`isRuntimeObject` | `boolean` | If true, this is an object spawned during runtime. Otherwise, it is an object that starts in the scene at load-time.
