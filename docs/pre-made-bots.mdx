...
![Marketplace overview](./img/marketplace/overview.png)
...
Once you are ready to use the bot, click "Create Bot".

![Marketplace details](./img/marketplace/detail.png)
...
![Create a new bot](./img/marketplace/create-bot.png)
