...
![Screenshot of the package imported into the project](../../getting-started/img/creating-your-first-automated-test/tutorial-1-package.png)
...
an account to sync your bot and get access to other [ready-to-go bots](./marketplace/pre-made-bots) and our
