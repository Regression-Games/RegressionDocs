...
follow the [first bot guide](../../getting-started/creating-your-first-automated-test) to create and configure a bot. As a quick test, you can make a bot that simply waits for a few seconds before completing its test. Note
...
[In-Editor Replay](../session-insights/img/in-editor-replay) for instructions on how to load replay data.

![Downloads](img/downloads.png)

![The timeline feature](img/timeline.png)