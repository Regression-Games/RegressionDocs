...
- Fixes a bug where certain OSX files would not be properly written
- Allow absolute paths to be used in segment and sequence loading
- Exclude transform renderers outside the view frustrum
- Fixed skewed bounding boxes in the Gameplay Session viewer
