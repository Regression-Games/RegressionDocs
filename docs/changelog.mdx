...
- The SDK now supports recording games using the legacy input system and Unity UI.
...
- Bounding boxes show entity locations within the gameplay session for improved debugging.
...
- Capture and replay of inputs handled via `Input.GetKey()`.
- An animation rigging package is now available for data capturing.
