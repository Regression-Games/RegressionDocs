...
<img src={TargetHeavyPotStep} alt="Target heavy pot" className="margin-bottom--md" style={{width: "45rem", display: "block", margin: "auto"}}/>
<img src={TargetHeavyPotSupplement} alt="Target heavy pot" className="margin-bottom--md" style={{width: "45rem", display: "block", margin: "auto"}}/>

Clicking on the pot to target it won't cause our character to approach it.
This means that now is a good time to store some values that we can use to validate that both the character and pot will move
in the next steps we build.
...
Validate that the character starts walks to the pot by waiting for her `position.x` to be greater than the value we just stored.
...
import PutDownPotSupplement from "./img/writing-advanced-validations/using-character-abilities/put-down-pot-supplement.png"

<img src={PutDownPotStep} alt="Put down the heavy pot" className="margin-bottom--md" style={{width: "45rem", display: "block", margin: "auto"}}/>
<img src={PutDownPotSupplement} alt="Put down the heavy pot" className="margin-bottom--md" style={{width: "45rem", display: "block", margin: "auto"}}/>
