...
- **Old vs New Unity Input System** - Playback of recordings is only supported for games using the new Unity Input System,
  as the old system does not easily allow for input simulation.
