...
You can either run **all** of the Scenarios within a Suite, or an individual Scenario. To run a Suite, click the "Run Suite" button. When the Suite is finished running, you can view the results of each Scenario within the Suite on the Test Runs page.

To run an individual Scenario, click the "Run Scenario" button within the Scenario's menu. The Scenario's results will be shown 
