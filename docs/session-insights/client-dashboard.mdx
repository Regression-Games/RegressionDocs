...
and to fine-tune your game's balance. To get started with validations, check out our docs for both [C#](../creating-bots/csharp/scenario-testing)
and [JavaScript](../creating-bots/javascript/scenario-testing) bots.
