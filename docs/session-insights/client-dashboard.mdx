...
and to fine-tune your game's balance. To get started with validations, check out our docs for both [C#](https://docs.regression.gg/studios/unity/unity-sdk/creating-bots/csharp/validation-bots)
and [JavaScript](https://docs.regression.gg/studios/unity/unity-sdk/creating-bots/javascript/validation-bots) bots.
