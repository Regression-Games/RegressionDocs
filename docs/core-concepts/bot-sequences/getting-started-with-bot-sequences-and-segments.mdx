...
After [adding the RGOverlayCanvas prefab to your scene](../../getting-started/installing-regression-games.mdx), click on the small Williward face icon to open the overlay. With the overlay opened, you can see the list of Bot Sequences that are available to you. Each Sequence is represented by a card, with three possible actions:
