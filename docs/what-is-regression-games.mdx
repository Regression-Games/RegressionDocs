...
| [Inspect and Validate Game State](core-concepts/validation-suites) | Review your recorded gameplay's screenshots, user inputs, and the internal state through our dashboard. Use these views to create test suites using no-code solutions. |
...
automated test](getting-started/creating-your-first-automated-test).
