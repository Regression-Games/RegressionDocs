...
| [Get Started Quickly with Recording and Input Playback](getting-started/creating-your-first-automated-test) | Create functional tests by recording a play-through of your scenario and preforming validations against automated playback. |
...
Before installing our SDK, you can always try our [live demo](https://play.regression.gg/validations-demo). Once you are ready to hop in, follow the
[installation guide](getting-started/installing-regression-games), after which you can 
...
You can also check out our [existing game samples](additional-game-samples).
