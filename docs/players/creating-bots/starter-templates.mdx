...
For this method, you can skip right to our sections on [writing your own AI code](./coding/dev-requirements#developing-ais-without-git) and [uploading it to our platform](TODO-REG-1023:-Add-section-and-link-here).
