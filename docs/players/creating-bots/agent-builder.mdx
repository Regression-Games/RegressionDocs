...
If you've used the Agent Builder to create a bot before, you can locate that bot in the Bot Manager and open the Agent Builder interface.
...
The below sample uses the [rg-bot library for Minecraft](https://github.com/Regression-Games/RegressionBot) to make the AI wander in a random direction. 
