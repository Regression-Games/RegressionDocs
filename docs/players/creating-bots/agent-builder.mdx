...
You can either manually fill in code using the editor (see [Writing Your Own Code](./coding/updating-your-ai)), or you can have GPT do the heavy lifting for you.
