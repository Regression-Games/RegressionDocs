...
(see this section's [overview](./adding-bots) for a walkthrough of AI creation).
...
You can either manually fill in code using the editor (see [Writing Your Own Code](./coding/dev-requirements)), or you can have GPT do the heavy lifting for you.
