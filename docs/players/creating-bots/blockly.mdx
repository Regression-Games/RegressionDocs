...
Create a new bot from the Bot Manager and select `Blockly` from the list of creation options
...
![Select Creation Option](./img/blockly/create-from-template.png)

## Loading Your Workspace

If you've used the Blockly editor to create a bot before, you can locate that bot in the Bot Manager and click on it to open the editor.
...
Save your workspace early and often! 
...
It's always a good idea to save your changes before switching to a different Blockly workspace or leaving the Regression Games website.
