...
You can read more about how to clone starter templates for your AIs using GitHub [here](../starter-templates).

In this section, we'll walk you through requirements for developing your AIs - this guide focuses on writing the AI yourself,
...
For this, you'll need to generate a personal access token.
