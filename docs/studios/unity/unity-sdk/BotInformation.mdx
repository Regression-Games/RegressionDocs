...
This `characterConfig` is the JavaScript Object that comes from the bot logic.
...
Overrides the `characterConfig` defined in the JavaScript code for your bot. For example, when seating a bot, you may discover 
