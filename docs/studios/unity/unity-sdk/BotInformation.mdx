...
Parses the JSON from [`characterConfig`](./creating-bots/configuration#characterconfig) into the serialized data type 
passed into the generic of this function. This [`characterConfig`](./creating-bots/configuration#characterconfig) 
...
#### Return Value
The object of type `T` that has been deserialized from JSON in the [`characterConfig`](./creating-bots/configuration#characterconfig) field.
...
Overrides the [`characterConfig`](./creating-bots/configuration#characterconfig) defined in the JavaScript code for your bot. For example, when seating a bot, you may discover 
