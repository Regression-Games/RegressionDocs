...
When loading a replay zip, the list of entity types to replay model associations will automatically be updated with any missing entities that have `isRuntimeObject=true`. You can also manually add, edit, or remove assocations at any time.
