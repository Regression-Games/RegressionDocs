...
public override void ProcessTick(RG rgObject)
{
    ...
    {
        rgObject.PerformAction(new RGActionRequest("PerformSkill", new Dictionary<string, object>()
        {
            { "skillId", 1 },
            { "targetId", enemy.id },
...
public override void ProcessTick(RG rgObject)
{
    if(rgObject.SceneName == "MainMenu")
    {
        ...
        if (selectGameModeButton != null && !_stateFlags["SelectGameModeButton"])
        {
            ...
            {
                { "targetId", selectGameModeButton.id }
            }));
        ...
        if (chooseArcherButton != null && _stateFlags["SelectGameModeButton"] && !_stateFlags["ChooseArcherButton"])
        {
            rgObject.PerformAction(new RGActionRequest("ClickButton", new Dictionary<string, object>
            {
                { "targetId", chooseArcherButton.id }
            }));
