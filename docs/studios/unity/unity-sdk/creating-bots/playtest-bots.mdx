...
This is Regression Games' entrypoint into your Bot logic, where you will define how your Bot makes decisions and reacts to the current game state.
...
The given name of the connected Bot. Readonly.
