...
![Select Creation Option](../../../../../common/agent-builder/img/create-for-unity.png)
...
You can either manually type code into the editor (see the [PlayTest Bots API](./playtest-bots)),
...
[//]: # (Whenever you save your tree, we generate multiple files and save them to your bot)
[//]: # (These contents include a config file named `agentBuilderWorkspace.json` which defines the nodes in your tree,)
