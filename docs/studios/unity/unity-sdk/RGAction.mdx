...
This allows the Regression Games SDK to recognize this method as the entrypoint into a callable action from your bot code ([C#](./csharp/configuration)) ([Javascript](./javascript/configuration)).
...
You can find these files in your Unity project under `RGScripts/RGActions`.
