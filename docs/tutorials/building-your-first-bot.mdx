...
![Screenshot of the search pane for the RGOverlayCanvas.](./img/building-your-first-bot/tick_rate.png)
...
![Screenshot of the player prefab with the components added.](./img/building-your-first-bot/generate_scripts.png)
...
![Screenshot of the player prefab with the components added.](./img/building-your-first-bot/player_7.png)
...
![Screenshot of the enemy prefab with the components added.](./img/building-your-first-bot/enemy_8.png)
