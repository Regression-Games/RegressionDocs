---
sidebar_label: 'Writing your first automation and test'
---

import OverlayPartial from '../partials/_add-overlay-partial.mdx';

# Writing your first automation and bot
...
more about these limitations in our [Gameplay Session recording docs]().
