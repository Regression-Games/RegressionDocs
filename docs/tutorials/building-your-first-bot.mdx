...
The SDK will ensure that only one instance is present across scenes or on scene transitions.
...
public int _currentHp; // CHANGE THIS TO PUBLIC - fields and methods must be public for Regression Games to see them
