...
![Add the Regression Games core SDK to your Unity project](img/installing-sdk.gif)
...
![Generate a new API key](../../core-concepts/api-keys/img/create-new-api-key.gif)

:::info
To learn more about our API keys, see the [Authenticating with API Keys](../../core-concepts/api-keys/authenticating-with-api-keys) section.
:::
...
Find the `RGOverlayCanvasV2` prefab by navigating to
...
Visit our documentation on the [Core Concepts](../../core-concepts/api-keys/authenticating-with-api-keys) that drive features in our SDK and client,
