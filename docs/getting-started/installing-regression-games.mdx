...
This extension allows our SDK to capture state data for Animation Rigging components.
...
This extension is for projects that use Unity's ECS framework.
...
at any time after installing the core SDK.
...
features such as saving [Gameplay Sessions](../core-concepts/gameplay-sessions)
and creating powerful [Validation Suites](../core-concepts/validation-suites).
...
[input recording and playback](../core-concepts/recording-gameplay)
...
The overlay prefab **must** be present in each scene where you want to use any Regression Games features.
