...
record a [Gameplay Session](../core-concepts/gameplay-sessions/gameplay-sessions-getting-started)
and create a [Validation Suite](../core-concepts/validation-suites/validation-suites-getting-started)
from the session for regression testing.
...
Follow our [installation instructions](../installation/installing-regression-games) to add our package to your game.
