...
- Record a [Gameplay Session](../core-concepts/gameplay-sessions/gameplay-sessions-getting-started) as an automated test
- Create a [Validation Suite](../core-concepts/validation-suites/validation-suites-getting-started) and run that against future test runs

![Screenshot of results from a run](./img/run-details.png)
...
more about these limitations in our [Gameplay Session recording docs](../core-concepts/gameplay-sessions/gameplay-sessions-getting-started).
...
![Screenshot of the playground scene](./img/bossroom.png)
...
![Gif of the package imported into the project](./img/installing-sdk.gif)
...
![Screenshot of the package imported into the project](./img/welcome_3.png)
...
The first step in automating a test is to record a [gameplay session](../core-concepts/gameplay-sessions/gameplay-sessions-getting-started).
...
recording. You can find the recordings within [the session directory](../core-concepts/gameplay-sessions/gameplay-sessions-reference#folder-and-file-structure).
...
[validation suite](../core-concepts/validation-suites/validation-suites-getting-started) using this session.
...
![Screenshot of the validation suite creation](./img/create-validation-suite.png)
...
![Screenshot the scenario builder](./img/create-validation-suite.png)
...
storing values for comparison (learn more in the [documentation for validations](../../core-concepts/validation-suites/validation-scenario-builder-reference)).
...
![Screenshot of results from a scenario](./img/run-scenario.png)
...
![Screenshot of the validation suite runs](./img/many-runs.png)
